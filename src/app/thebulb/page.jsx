    ...
    <div className="bg-neutral-950 w-full ">
      ...
      <div className="w-[95%] md:w-[75%] mx-auto  text-white  space-y-8  pt-28 pb-10">
        ...
        <div className="mx-auto  space-y-8">
          ...
          <p className="opacity-60 md:pt-8 text-[15px] md:text-[18px]">
            ...
            particular products the company had as at the time of establishment
            as it was a new entity with a lot of drive and passion to help
            businesses grow and attain full potential, also they wanted to help
          ...
          <p className="opacity-60 pt-8 text-[15px] md:text-[18px]">
            ...
            Africa offers Saas and B2B services. It was important to ensure our
        ...
        <div className="mx-auto  space-y-8">
          ...
          <p className="opacity-60 text-[15px] md:text-[18px]">
            ...
            change as the solution we were building wasn’t for us. I and the
            team of engineers picked a day to have meetings with a few of the
            companies we serviced. Getting the representatives of each company
            to get their business analysts to fill out a quick survey to help us
            narrow down their most visited screens and get back to us took time
          ...
          <p className="opacity-60 text-[15px] md:text-[18px]">
            ...
            multiple iterations to get the best way to pass across what The
          ...
          <p className="opacity-60 text-[15px] md:text-[18px]">
            ...
            typography and use of colors conveyed that the company understands
            how difficult it is to operate a business and sympathizes with these
        ...
        <Image
          src={bulb12}
          alt="bulb12"
          className="mx-auto hidden md:block pt-6"
        />
        ...
        <p className="opacity-60 md:text-[18px]">
