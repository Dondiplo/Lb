...
export default function Home() {
  return (
    <main className="snap-y snap-mandatory h-screen w-screen overflow-scroll scroll-smooth ">
      ...
      >
        <h1 className="text-white z-10 text-xl">Hi 👋🏽 , I’m Tega</h1>
      ...
      >
        <h1 className="text-white z-10 w-[80%] md:w-[40%] text-center text-xl">
      ...
      <section
        id="bg3"
        class="snap-start min-h-screen flex justify-center relative items-center  bg-fixed bg-no-repeat bg-cover bg-center"
      ><h1 className="text-white z-10 w-[80%] md:w-[40%] text-xl text-center">You get to see a few of my favourite projects, some from a few years back 
